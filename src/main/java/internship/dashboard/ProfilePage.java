...
public class ProfilePage extends JPanel {
    ...
    private JPanel buildProfileCard() {
        ...
        gbc.gridx = 0; gbc.gridy = 0; gbc.weightx = 0.25; formPanel.add(styledLabel("User ID"), gbc);
        gbc.gridx = 1; gbc.weightx = 0.75; formPanel.add(txtUserId, gbc);
        gbc.gridx = 2; gbc.weightx = 0.25; formPanel.add(styledLabel("Full Name"), gbc);
        gbc.gridx = 3; gbc.weightx = 0.75; formPanel.add(txtName, gbc);

        gbc.gridx = 0; gbc.gridy = 1; gbc.weightx = 0.25; formPanel.add(styledLabel("Email"), gbc);
        gbc.gridx = 1; gbc.weightx = 0.75; formPanel.add(txtEmail, gbc);
        gbc.gridx = 2; gbc.weightx = 0.25; formPanel.add(styledLabel("Phone"), gbc);
        gbc.gridx = 3; gbc.weightx = 0.75; formPanel.add(txtPhone, gbc);

        gbc.gridx = 0; gbc.gridy = 2; gbc.weightx = 0.25; formPanel.add(styledLabel("Role"), gbc);
        gbc.gridx = 1; gbc.weightx = 0.75; formPanel.add(txtRole, gbc);
        gbc.gridx = 2; gbc.weightx = 0.25; formPanel.add(styledLabel("Gender"), gbc);
        gbc.gridx = 3; gbc.weightx = 0.75; formPanel.add(cmbGender, gbc);
    ...
    private JPanel buildCvCard() {
        ...
        btnViewCv = styledButton("View CV", new Color(40, 42, 44));
        btnViewCv.setPreferredSize(new Dimension(120, 34));
        btnViewCv.setEnabled(false);

        btnRemoveCv = styledButton("Remove", new Color(40, 42, 44));
